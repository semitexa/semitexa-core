...
/**
 * Thrown when the parser encounters a GraphQL feature that
...
final class UnsupportedGraphqlFeatureException extends DomainException
{
    public function __construct(
        ...
        parent::__construct(sprintf(
            'Unsupported GraphQL feature: %s. This is a bounded selection-set bridge, not a full GraphQL executor.%s',
            $feature,
            $hint !== '' ? ' ' . $hint : '',
        ));
    }
